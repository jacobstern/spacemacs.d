...
values."
  (setq-default
   ...
   '(
     ...
     (spacemacs-ui :packages (restart-emacs winum))
     themes-megapack
     helm
     (auto-completion :variables
                      auto-completion-return-key-behavior 'none
...
you should place your code here."
  (add-hook 'prog-mode-hook
            (lambda () (setq-local helm-mode-handle-completion-in-region nil)))
