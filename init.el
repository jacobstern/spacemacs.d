...
you should place your code here."
  (add-hook 'prog-mode-hook (lambda () (setq-local helm-mode-handle-completion-in-region nil)))
  (use-package company
    :config
